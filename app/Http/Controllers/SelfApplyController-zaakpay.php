...
-----END PUBLIC KEY-----';       //header key
    ...
    public function buyNow()
    {
        ...
        $pdfUrl = 'https://loanzilla.com/application-pdf/'.$encUserId;
        ...
        try {
            ...
            if ($checksum == $recd_checksum) {
                ...
                if ($responseCode == 100 || $responseCode == 208 || /* $responseCode == 102 || */ $responseCode == 601) {
                    ...
                    sendBrevoHtmlMail2($mailData, 'Congratulations! Payment Successful for Loanzilla Self-Apply Plan.', $sendGreetings, 3, $pdf);
                    if ($response2 > 0) {
            ...
            if (isset($loanType, $applyId, $orderId) && $loanType !== null && $applyId !== null && $orderId !== null) {
                ...
                if(Cookie::has('utm_source') && Cookie::get('utm_source') == 'facebook'){
                    ...
                    $fbdata = array(
    						...
    						'sourceurl' => 'https://loanzilla.com/self-apply/paymentSuccess'
    					);
    				if ($fbleads->fbclid != "") {
    ...
    public function getOffer1(Request $request)
    {
        try{
            ...
            $returnUrl = 'https://loanzilla.com/api/self-apply/prime-offer-response';
    ...
    public function getOffer2(Request $request)
    {
        try{
            ...
            $orderId = number_format(microtime(true) * 1000, 0, '.', '');
            $encData = null;
            $returnUrl = 'https://loanzilla.com/api/self-apply/mega-offer-response';
    ...
    public function getOffer3(Request $request)
    {
        try{
            ...
            $orderId = number_format(microtime(true) * 1000, 0, '.', '');
            $encData = null;
            $returnUrl = 'https://loanzilla.com/api/self-apply/premium-offer-response';
    ...
    public function getOffer4(Request $request)
    {
        try{
           ...
           // Log::info('products - '.json_encode($products));
            ...
            $returnUrl = 'https://loanzilla.com/api/self-apply/star-offer-response';
    ...
    public function getOffer5(Request $request)
    {
        try{
            ...
            $returnUrl = 'https://loanzilla.com/airpay-response';
    ...
    public function getOffer7(Request $request){
        try{
            ...
            $redirect_url = 'https://loanzilla.com/api/self-apply/offer-7-response';         // Required - http://, https://, http://www, https://www
